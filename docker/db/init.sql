...
-- docker
LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/postcodes.csv' INTO TABLE `postcodes` FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';


INSERT IGNORE INTO categories VALUES ( 1, '野菜' );
INSERT IGNORE INTO categories VALUES ( 2, '果物' );
INSERT IGNORE INTO categories VALUES ( 3, 'その他' );


INSERT IGNORE INTO items VALUES ( 1, 'たまねぎ', 'たまねぎ(愛媛県産)旬の季節は、秋から冬です。栄養素は、クエルセチン（強力な抗酸化物質）、ビタミンC、ビタミンB6、カリウムが豊富に含まれています。', 150, 'tamanegi.jpg', 1 );

INSERT IGNORE INTO items VALUES ( 2, 'にんじん', 'にんじん(茨城県産)旬の季節は、秋から冬です。栄養素は、クエルセチン（強力な抗酸化物質）、ビタミンC、ビタミンB6、カリウムが豊富に含まれています。', 100, 'ninjin.jpg', 1 );

INSERT IGNORE INTO items VALUES ( 3, 'ピーマン', 'ピーマン(高知県産)旬の季節は、夏です。栄養素は、ビタミンC、ビタミンB6、ビタミンA、カプサイシン（特に赤ピーマン）が豊富に含まれています。', 120, 'pi-man.jpg', 1 );

INSERT IGNORE INTO items VALUES ( 4, 'なす', 'なす(熊本県産)旬の季節は、夏です。栄養素は、ナスニン（抗酸化物質）、食物繊維、ビタミンB1、ビタミンB6が豊富に含まれています', 110, 'nasu.jpg', 1 );
...
INSERT IGNORE INTO items VALUES ( 55, 'エノキ', 'エノキ(長野県産)旬の季節は、秋から冬です。栄養素は、ビタミンB群、食物繊維が豊富に含まれています。', 70, 'enoki.jpg', 1 );
...
-- ; INSERT INTO items VALUES ( 31,  '牛乳', '牛乳(北海道産)1年中飲まれる人気の食材です。栄養素は、カルシウム、ビタミンD、ビタミンB12、リンが豊富に含まれています。', 210, 'milk.jpg', 1 );

-- ; INSERT INTO items VALUES ( 45, 'マグロ', 'マグロ(国産、海外産)1年中食べられる人気の食材です。栄養素は、タンパク質、オメガ3脂肪酸、ビタミンD、鉄が豊富に含まれています。', 1500, 'maguro.jpg', 3 );



--  IF NOT EXISTSとIGNORE : すでにテーブルがある場合は作成しない、ない場合のにのみ作成、重複した場合のエラー回避