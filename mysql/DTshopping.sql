...
INSERT INTO items VALUES ( 7,  'みかん', 'みかん(愛媛県産)旬の季節は、冬です。栄養素は、ビタミンC、ビタミンA、カリウム、食物繊維が豊富に含まれています。', 250, 'orange.jpg', 2 );
...
INSERT INTO items VALUES ( 23,  'りんご', 'りんご(青森県産)旬の季節は、秋です。栄養素は、食物繊維、ビタミンC、カリウム、ポリフェノールが豊富に含まれています。', 230, 'mikan.jpg', 2 );
